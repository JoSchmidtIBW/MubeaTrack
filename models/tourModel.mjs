...
const tourSchema = new mongoose.Schema(
  {
    ...
    priceDiscount: {
      // eigener validator, welcher schaut, ob pricediscount grösser= als price
      type: Number,
      validate: {
        validator: function (val) {
          // funktion geht nur bei create, nicht bei update        https://github.com/validatorjs/validator.js
    ...
    // "name": "The Test Tour",
    guides: [
      // referrences   sind auch sub-documents, embedded dokuments
      {
